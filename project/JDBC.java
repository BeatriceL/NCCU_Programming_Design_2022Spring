...
public class JDBC {
 ...
 public void enroll(String inputName, String inputPassword, String inputMail) {
  try {
   ...
   PreparedStatement stat = conn
     .prepareStatement("INSERT INTO finalUsers (Account, Password, Email) VALUES (?, ?, ?)");
 ...
 // 更改個人資訊
 public void updatePassword(String account, String editPassword) {
  try {
   // 連接資料庫
   getConnection();

   // 更新密碼
   PreparedStatement stat = conn.prepareStatement("UPDATE finalUsers SET Password = ? WHERE Account = ?");
   stat.setString(1, editPassword);
 ...
 //發文
 public void post(String selectedBoard, String posterName, String postTitle, String postContent) {
        String boardName = ""; // 資料庫表名稱，根據選擇的選項設定
  boardName = selectedBoard;
        ...
        try {
            ...
            // 文章放到資料庫
            String sql = "INSERT INTO " + boardName  + " (Poster, Title, Content) VALUES (?, ?, ?)";
            PreparedStatement statement = conn.prepareStatement(sql);
            statement.setString(1, posterName);
